      ...
      <main className="max-w-6xl mx-auto px-4 pt-10 pb-16 md:pt-14 md:pb-20 space-y-10">
        ...
        {(hasYoutube || hasInstagram || hasLocalVideo) && !useInstagramSplit && (
          <section>
            {hasYoutube ? (
              ...
              // Instagram (post / reel)
              <div className="w-full max-w-[220px] sm:max-w-[260px] mx-auto rounded-2xl overflow-hidden border border-zinc-800 bg-black shadow-[0_25px_70px_rgba(0,0,0,0.7)]">
        ...
        {useInstagramSplit ? (
          <section className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-start">
            <div className="w-full max-w-[240px] sm:max-w-[280px] mx-auto lg:mx-0 rounded-2xl overflow-hidden border border-zinc-800 bg-black shadow-[0_25px_70px_rgba(0,0,0,0.7)]">
              <div className="aspect-[9/16]">
                <iframe
                  src={instagramEmbedUrl}
                  title={project.title}
